...
public class EnumerationTests
{
    ...
    {
        Action result = () => TestEnumeration.Create(key!);
    ...
    {
        // Explicitly tests the operator==(T?, string?) overload with both sides null.
        var isEqual = (TestEnumeration?)null == (string?)null;
