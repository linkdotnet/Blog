...
{
    private readonly IAnalyticsRepository repositoryMock;
    ...
    {
        repositoryMock = Substitute.For<IAnalyticsRepository>();
    ...
    public async Task ShouldStoreInformation()
    {
        ...
        repositoryMock.When(r => r.StoreUserRecordAsync(Arg.Any<UserRecord>()))
    ...
    public async Task ShouldNotStoreForAdmin()
    {
        ...
        await repositoryMock.Received(0).StoreUserRecordAsync(Arg.Any<UserRecord>());
    }
